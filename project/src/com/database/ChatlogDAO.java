...
public class ChatlogDAO extends BaseHibernateDAO {
	...
	public List findByUserid1(Object userid1) {
		return findByProperty(USERID1, userid1);
	}

	public List findByUserid2(Object userid2) {
		return findByProperty(USERID2, userid2);
	}
	...
	public List findByMemo1(Object memo1) {
		return findByProperty(MEMO1, memo1);
	}

	public List findByMemo2(Object memo2) {
		return findByProperty(MEMO2, memo2);
	}
